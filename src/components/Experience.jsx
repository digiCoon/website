    ...
    const entries = [
        {
            ...
            period: 'jul 25 - heute',
            details: ['umschulung mit schwerpunkten ->', 'java, python, webentwicklung, datenbanken, linux & it-security']
        },
        {
            type: 'education',
        ...
        },
        {
            ...
            details: ['ihk-abschluss, verkürzt von 3 auf 2 jahre', 'schwerpunkt it-vertrieb & it-systemlösungen (tk-anlagen)']
        }
    ]
