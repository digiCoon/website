    ...
    return (
        <section id="legal">
            ...
            <p>Ich freue mich sehr über Ihr Interesse an meiner Website. Datenschutz hat für mich einen besonders hohen
                ...
                möglich. Sofern eine betroffene Person besondere Services über meine Internetseite in Anspruch nehmen
            ...
            <p>Betroffene Person ist jede identifizierte oder identifizierbare natürliche Person, deren personenbezogene
                Daten von der für die Verarbeitung Verantwortlichen verarbeitet werden.</p>
            ...
            <p>Verantwortliche oder für die Verarbeitung Verantwortliche ist die natürliche oder juristische Person, Behörde,
                ...
                Verarbeitung von personenbezogenen Daten entscheidet.</p>

            <h4>h) Auftragsverarbeiter</h4>
            <p>Auftragsverarbeiter ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle,
                die personenbezogene Daten im Auftrag der Verantwortlichen verarbeitet.</p>
            ...
            <p>Dritter ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle außer der
                betroffenen Person, der Verantwortlichen, dem Auftragsverarbeiter und den Personen, die unter der
                unmittelbaren Verantwortung der Verantwortlichen oder des Auftragsverarbeiters befugt sind, die
            ...
            <h3>2. Name und Anschrift der für die Verarbeitung Verantwortlichen</h3>
            <p>Verantwortliche im Sinne der Datenschutz-Grundverordnung, sonstiger in den Mitgliedstaaten der Europäischen
                Union geltenden Datenschutzgesetze und anderer Bestimmungen mit datenschutzrechtlichem Charakter bin ich.
                Die Kontaktdaten finden Sie im <a href="#impressum">Impressum dieser Website</a>.</p>
            <h3>3. Erfassung von allgemeinen Daten und Informationen</h3>
            <p>Meine Internetseite erfasst mit jedem Aufruf durch eine betroffene Person oder ein automatisiertes System
                eine Reihe von allgemeinen Daten und Informationen. Diese allgemeinen Daten und Informationen werden in
                den Logfiles des Servers gespeichert. Erfasst werden können die (1) verwendeten Browsertypen und Versionen,
                (2) das vom zugreifenden System verwendete Betriebssystem, (3) die Internetseite, von welcher ein
                zugreifendes System auf meine Internetseite gelangt (sogenannte Referrer), (4) die Unterwebseiten, welche
                über ein zugreifendes System auf meiner Internetseite angesteuert werden, (5) das Datum und die Uhrzeit
                ...
                die der Gefahrenabwehr im Falle von Angriffen auf meine informationstechnologischen Systeme dienen.</p>

            <p>Bei der Nutzung dieser allgemeinen Daten und Informationen ziehe ich keine Rückschlüsse auf die betroffene
                Person. Diese Informationen werden vielmehr benötigt, um (1) die Inhalte meiner Internetseite korrekt
                auszuliefern, (2) die dauerhafte Funktionsfähigkeit meiner informationstechnologischen Systeme und der
                Technik meiner Internetseite zu gewährleisten sowie (3) um Strafverfolgungsbehörden im Falle eines
                Cyberangriffes die zur Strafverfolgung notwendigen Informationen bereitzustellen. Diese anonym erhobenen
                Daten und Informationen werden von mir daher einerseits statistisch und ferner mit dem Ziel ausgewertet,
                den Datenschutz und die Datensicherheit zu erhöhen, um letztlich ein optimales Schutzniveau für die von
                mir verarbeiteten personenbezogenen Daten sicherzustellen. Die anonymen Daten der Server-Logfiles werden
            ...
            <p>Meine Internetseite enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine schnelle elektronische
                Kontaktaufnahme sowie eine unmittelbare Kommunikation mit mir ermöglichen, was ebenfalls eine allgemeine
                Adresse der sogenannten elektronischen Post (E-Mail-Adresse) umfasst. Sofern eine betroffene Person per
                E-Mail oder über ein Kontaktformular den Kontakt mit mir aufnimmt, werden die von der betroffenen Person
                übermittelten personenbezogenen Daten automatisch gespeichert. Solche auf freiwilliger Basis von einer
                betroffenen Person übermittelten personenbezogenen Daten werden für Zwecke der Bearbeitung oder der
            ...
            <p>Ich verarbeite und speichere personenbezogene Daten der betroffenen Person nur für den Zeitraum, der zur
                Erreichung des Speicherungszwecks erforderlich ist oder sofern dies durch den Europäischen Richtlinien-
                und Verordnungsgeber oder einen anderen Gesetzgeber in Gesetzen oder Vorschriften, welchen ich unterliege,
                vorgesehen wurde.</p>

            <p>Entfällt der Speicherungszweck oder läuft eine vorgeschriebene Speicherfrist ab, werden die
            ...
            <p>Jede betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber eingeräumte Recht, von
                mir eine Bestätigung darüber zu verlangen, ob sie betreffende personenbezogene Daten verarbeitet werden.
                Möchte eine betroffene Person dieses Bestätigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit
                an mich wenden.</p>

            <h4>b) Recht auf Auskunft</h4>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                und Verordnungsgeber gewährte Recht, jederzeit von mir unentgeltliche Auskunft über die zu ihrer Person
            ...
            <ul>
                ...
                <li>die Empfänger oder Kategorien von Empfängern, gegenüber denen die personenbezogenen Daten offengelegt
                    worden sind oder noch offengelegt werden</li>
                <li>falls möglich die geplante Dauer, für die die personenbezogenen Daten gespeichert werden, oder die
                ...
                <li>das Bestehen eines Rechts auf Berichtigung oder Löschung der sie betreffenden personenbezogenen Daten
                    oder auf Einschränkung der Verarbeitung oder eines Widerspruchsrechts gegen diese Verarbeitung</li>
                ...
                <li>das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling gemäß Artikel 22
                    Abs. 1 und 4 DS-GVO und aussagekräftige Informationen über die involvierte Logik sowie die Tragweite
            ...
            <p>Ferner steht der betroffenen Person ein Auskunftsrecht darüber zu, ob personenbezogene Daten an ein
                Drittland oder an eine internationale Organisation übermittelt wurden. Möchte eine betroffene Person
                dieses Auskunftsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit an mich wenden.</p>

            <h4>c) Recht auf Berichtigung</h4>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                und Verordnungsgeber gewährte Recht, die unverzügliche Berichtigung sie betreffender unrichtiger
                personenbezogener Daten zu verlangen. Ferner steht der betroffenen Person das Recht zu, die
                Vervollständigung unvollständiger personenbezogener Daten zu verlangen. Möchte eine betroffene Person
                dieses Berichtigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit an mich wenden.</p>

            <h4>d) Recht auf Löschung (Recht auf Vergessenwerden)</h4>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                und Verordnungsgeber gewährte Recht, von mir zu verlangen, dass die sie betreffenden personenbezogenen
            ...
            <ul>
                ...
                <li>Die betroffene Person widerruft ihre Einwilligung, auf die sich die Verarbeitung stützte, und es
                    fehlt an einer anderweitigen Rechtsgrundlage für die Verarbeitung.</li>
                <li>Die betroffene Person legt Widerspruch gegen die Verarbeitung ein, und es liegen keine vorrangigen
                    berechtigten Gründe für die Verarbeitung vor.</li>
                <li>Die personenbezogenen Daten wurden unrechtmäßig verarbeitet.</li>
                <li>Die Löschung der personenbezogenen Daten ist zur Erfüllung einer rechtlichen Verpflichtung erforderlich.</li>
            ...
            <p>Sofern einer der oben genannten Gründe zutrifft, kann sich die betroffene Person hierzu jederzeit an mich
                wenden. Ich werde veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.</p>

            <h4>e) Recht auf Einschränkung der Verarbeitung</h4>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                und Verordnungsgeber gewährte Recht, von mir die Einschränkung der Verarbeitung zu verlangen, wenn eine
                der folgenden Voraussetzungen gegeben ist:</p>
            <ul>
                <li>Die Richtigkeit der personenbezogenen Daten wird von der betroffenen Person bestritten, für eine
                    Dauer, die es mir ermöglicht, die Richtigkeit zu überprüfen.</li>
                <li>Die Verarbeitung ist unrechtmäßig, die betroffene Person lehnt die Löschung ab und verlangt stattdessen
                    die Einschränkung der Nutzung.</li>
                <li>Ich benötige die personenbezogenen Daten für die Zwecke der Verarbeitung nicht länger, die betroffene
                    Person benötigt sie jedoch zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen.</li>
                <li>Die betroffene Person hat Widerspruch gegen die Verarbeitung eingelegt und es steht noch nicht fest,
                    ob meine berechtigten Gründe gegenüber denen der betroffenen Person überwiegen.</li>
            </ul>
            <p>Sofern eine der oben genannten Voraussetzungen gegeben ist, kann sich die betroffene Person hierzu
                jederzeit an mich wenden.</p>

            <h4>f) Recht auf Datenübertragbarkeit</h4>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                und Verordnungsgeber gewährte Recht, die sie betreffenden personenbezogenen Daten, welche durch die
                betroffene Person bereitgestellt wurden, in einem strukturierten, gängigen und maschinenlesbaren Format
                zu erhalten. Sie hat außerdem das Recht, diese Daten einem anderen Verantwortlichen zu übermitteln,
                sofern die Verarbeitung auf einer Einwilligung oder einem Vertrag beruht und mithilfe automatisierter
                Verfahren erfolgt. Zur Geltendmachung dieses Rechts kann sich die betroffene Person jederzeit an mich wenden.</p>
            ...
            <p>Ich verarbeite die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es sei denn, ich kann
                ...
                Verteidigung von Rechtsansprüchen. Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person
                direkt an mich wenden.</p>
            ...
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                ...
                Wirkung entfaltet oder sie in ähnlicher Weise erheblich beeinträchtigt. Möchte die betroffene Person Rechte
                mit Bezug auf automatisierte Entscheidungen geltend machen, kann sie sich hierzu jederzeit an mich wenden.</p>

            <h4>i) Recht auf Widerruf einer datenschutzrechtlichen Einwilligung</h4>
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
                und Verordnungsgeber gewährte Recht, eine Einwilligung zur Verarbeitung personenbezogener Daten jederzeit
                zu widerrufen. Möchte die betroffene Person ihr Recht auf Widerruf geltend machen, kann sie sich hierzu
                jederzeit an mich wenden.</p>
            ...
            <p>Basiert die Verarbeitung personenbezogener Daten auf Artikel 6 I lit. f DS-GVO, ist mein berechtigtes
                Interesse der Betrieb und die Pflege dieser Portfolio-Website sowie die Bearbeitung eingehender
                Kontaktanfragen.</p>
            ...
            <p>Das Kriterium für die Dauer der Speicherung von personenbezogenen Daten ist die jeweilige gesetzliche
                ...
                sie nicht mehr zur Bearbeitung einer Anfrage erforderlich sind.</p>

            <h3>10. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen Daten</h3>
            <p>Die Bereitstellung personenbezogener Daten ist weder gesetzlich noch vertraglich vorgeschrieben, sofern
                nicht anders angegeben. Eine Bereitstellung ist erforderlich, um eine über das Kontaktformular gestellte
                Anfrage bearbeiten zu können. Eine Nichtbereitstellung der personenbezogenen Daten hätte zur Folge, dass
                die Anfrage nicht bearbeitet werden kann.</p>
